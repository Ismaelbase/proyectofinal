...
class Admin_chats : Fragment() {

    private var _binding: FragmentAdminChatsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminChatsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycler = binding.chatPublicoRecycler
        texto = binding.chatPublicoTexto
        enviar = binding.chatPublicoEnviar
        usuarios = binding.chatPublicoListaUsuarios
        ...
        enviar.setOnClickListener {
            ...
            if (txt != "") { //Si el mensaje no es vacío
                ...
                Toast.makeText(ap.applicationContext, "Mensaje vacío", Toast.LENGTH_SHORT).show()
            }
        }
        ...
        usuarios.setOnClickListener {
            startActivity(Intent(ap.applicationContext, Admin_moderar_usuarios::class.java))
        }

        recycler.adapter = Adaptador_Chat_Articulo(lista)
        recycler.layoutManager = LinearLayoutManager(ap.applicationContext)
