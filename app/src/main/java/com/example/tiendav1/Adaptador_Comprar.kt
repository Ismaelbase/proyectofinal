...
class Adaptador_Comprar(private val lista_articulos: MutableList<Articulo>, var filtros_check: List<Boolean>) :
    ...
    override fun onBindViewHolder(holder: UserViewHolder, posicion: Int) {
        ...
        holder.puntos.text = "Puntos: "+item_actual.puntos
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                lista_filtrada = lista_filtrada.filter {
                    var posicion = Articulo.categoria.indexOf(it.categoria)
    ...
    inner class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val imagen: ImageView = itemView.findViewById(R.id.articulo_imagen)
        val nombre: TextView = itemView.findViewById(R.id.articulo_nombre)
        val precio: TextView = itemView.findViewById(R.id.articulo_precio)
